...
export interface ApiArtArt extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    wall: Schema.Attribute.Relation<'manyToOne', 'api::wall.wall'>;
...
export interface ApiCityCity extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    walls: Schema.Attribute.Relation<'oneToMany', 'api::wall.wall'>;
  };
}
...
export interface ApiWallWall extends Struct.CollectionTypeSchema {
