...
// Unified icon set — Feather/Lucide style: 24×24 viewBox, stroke, rounded caps.
// Usage: <Heart size={16} /> or <Eye className="..." />

type IconProps = SVGProps<SVGSVGElement> & { size?: number; filled?: boolean }

const Svg = ({ size = 20, children, ...props }: IconProps & { children: React.ReactNode }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
